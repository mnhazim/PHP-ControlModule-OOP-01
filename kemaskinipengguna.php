<?php
  ...
  $sqlget = "SELECT * FROM pengguna WHERE id_pengguna = '$idup'";
  $rsget = mysqli_query($conn, $sqlget) or die (mysqli_error($conn));
  $row = mysqli_fetch_array($rsget);
      ...
      <div class="row">
        <div class="col-md-6">
        	<div class="box box-danger">
        		...
        		<form action="control/control.php?mode=update" method="post">
	          	<div class="box-body">
